...
LabelCategoryLightAdviser _$LabelCategoryLightAdviserFromJson(Map<String, dynamic> json) => LabelCategoryLightAdviser(
      json['title'] as String?,
      InfoSection.fromJson(json['info_section'] as Map<String, dynamic>),
      (json['bulb_images'] as List<dynamic>).map((e) => BulbImage.fromJson(e as Map<String, dynamic>)).toList(),
      (json['brightness_levels'] as Map<String, dynamic>).map(
        (k, e) => MapEntry($enumDecode(_$BrightnessTypeEnumMap, k), Brightness.fromJson(e as Map<String, dynamic>)),
      ),
      (json['rooms'] as Map<String, dynamic>).map(
        (k, e) => MapEntry($enumDecode(_$RoomTypeEnumMap, k), Room.fromJson(e as Map<String, dynamic>)),
      ),
...
Map<String, dynamic> _$LabelCategoryLightAdviserToJson(LabelCategoryLightAdviser instance) => <String, dynamic>{
      ...
      'brightness_levels': instance.brightnessLevels.map((k, e) => MapEntry(_$BrightnessTypeEnumMap[k], e)),
...
Map<String, dynamic> _$InfoSectionToJson(InfoSection instance) => <String, dynamic>{
...
BulbImage _$BulbImageFromJson(Map<String, dynamic> json) => BulbImage(
...
BrightnessRoom _$BrightnessRoomFromJson(Map<String, dynamic> json) => BrightnessRoom(
      $enumDecode(_$BrightnessTypeEnumMap, json['brightness']),
      $enumDecode(_$RoomTypeEnumMap, json['room']),
    );

Map<String, dynamic> _$BrightnessRoomToJson(BrightnessRoom instance) => <String, dynamic>{
...
Map<String, dynamic> _$BrightnessToJson(Brightness instance) => <String, dynamic>{
