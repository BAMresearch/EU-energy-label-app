...
LabelCategory _$LabelCategoryFromJson(Map<String, dynamic> json) => LabelCategory(
      ...
      checklistData: json['label_category_checklist_data'] == null
          ? null
          : LabelCategoryChecklistData.fromJson(json['label_category_checklist_data'] as Map<String, dynamic>),
      tipData: json['label_category_tips'] == null
          ? null
          : LabelCategoryTipData.fromJson(json['label_category_tips'] as Map<String, dynamic>),
      guideData: json['label_category_guide'] == null
          ? null
          : LabelCategoryGuideData.fromJson(json['label_category_guide'] as Map<String, dynamic>),
      lightAdviser: json['label_category_light_adviser'] == null
          ? null
          : LabelCategoryLightAdviser.fromJson(json['label_category_light_adviser'] as Map<String, dynamic>),
      visible: json['visible'] as bool?,
      favoriteOnly: json['favorite_only'] as bool?,
    );

Map<String, dynamic> _$LabelCategoryToJson(LabelCategory instance) => <String, dynamic>{
