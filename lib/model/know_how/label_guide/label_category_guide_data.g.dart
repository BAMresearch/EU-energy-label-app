...
LabelCategoryGuideData _$LabelCategoryGuideDataFromJson(Map<String, dynamic> json) => LabelCategoryGuideData(
      ...
      fridgeLeftSideInfoZones: (json['fridge_left_info_zones'] as List<dynamic>?)
          ...
          .toList(),
      fridgeRightSideInfoZones: (json['fridge_right_info_zones'] as List<dynamic>?)
          ?.map((e) => FridgeInfoZoneData.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$LabelCategoryGuideDataToJson(LabelCategoryGuideData instance) => <String, dynamic>{
...
FridgeInfoZoneData _$FridgeInfoZoneDataFromJson(Map<String, dynamic> json) => FridgeInfoZoneData(
      description: json['field_zone'] as String?,
      tooltipHtml: json['field_tooltip'] as String?,
    );

Map<String, dynamic> _$FridgeInfoZoneDataToJson(FridgeInfoZoneData instance) => <String, dynamic>{
