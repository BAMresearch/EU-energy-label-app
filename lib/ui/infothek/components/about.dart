...
class _LicensePageState extends State<LicensePage> {
  ...
  Widget build(BuildContext context) {
    return _MasterDetailFlow(
      ...
      title: Text(
        MaterialLocalizations.of(context).licensesPageTitle.toUpperCase(),
        style: BamTextStyles.headline6,
      ),
      ...
      page = Scaffold(
        appBar: AppBar(
          ...
          title: _PackageLicensePageTitle(
            title,
            subtitle,
            BamTextTheme.textTheme, // theme.appBarTheme.textTheme ?? theme.primaryTextTheme,
          ),
        ),
        body: Center(
          child: Material(
...
class _MasterDetailFlow extends StatefulWidget {
  ...
  static _MasterDetailFlowProxy? of(BuildContext context) {
    ...
    assert(() {
      if (pageOpener == null) {
        throw FlutterError('Master Detail operation requested with a context that does not include a Master Detail '
                ...
                return AnimatedSwitcher(
                  transitionBuilder: (Widget child, Animation<double> animation) =>
                      const FadeUpwardsPageTransitionsBuilder()
                          .buildTransitions<void>(null, null, animation, null, child),
