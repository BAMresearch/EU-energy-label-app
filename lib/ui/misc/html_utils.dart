...
class HtmlUtils {
  static Widget stringToHtml(
    ...
    return Html(
      ...
      customRender: {
        'img': (context, child, attributes, currentElement) =>
            _customRenderImg(context, child, attributes, currentElement),
        'a': (context, child, attributes, currentElement) =>
            _customRenderA(context, child, attributes, currentElement, internalOnTap),
        'li': (context, child, attributes, currentElement) =>
            _customRenderLi(context, child, attributes, currentElement, padding, bulletColor),
      },
    );
  }
  ...
  static Widget _customRenderA(RenderContext context, Widget child, Map<String, String> attributes,
      dom.Element currentElement, void Function(String link) onLinkTap) {
    Widget widget;
  ...
  static Widget _customRenderLi(RenderContext context, Widget child, Map<String, String> attributes,
      dom.Element currentElement, EdgeInsets padding, Color bulletColor) {
